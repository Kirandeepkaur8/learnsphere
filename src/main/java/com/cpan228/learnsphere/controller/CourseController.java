...
public class CourseController {
    ...
    public String updateCourse(
        ...
        if (StringUtils.hasText(
                submittedCourse.getCourseCode()
        ) && courseRepository
                .existsByCourseCodeIgnoreCaseAndIdNot(
                        submittedCourse
                                .getCourseCode()
                                .trim(),
                        id
        ...
        existingCourse.setTitle(
                submittedCourse.getTitle()
        );
        existingCourse.setInstructorName(
                submittedCourse.getInstructorName()
        );
        existingCourse.setCategory(
                submittedCourse.getCategory()
        );
        existingCourse.setDifficulty(
                submittedCourse.getDifficulty()
        );
        existingCourse.setDurationWeeks(
                submittedCourse.getDurationWeeks()
        );
        existingCourse.setPrice(
                submittedCourse.getPrice()
        );
        existingCourse.setDescription(
                submittedCourse.getDescription()
        );
